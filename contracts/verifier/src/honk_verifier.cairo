...
use super::honk_verifier_circuits::{
    is_on_curve_excluding_infinity_bn254, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_10_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_10_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_10_circuit,
    run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_10_circuit,
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_10_PUB_18_circuit,
};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_10_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_DONE_SIZE_10_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_10_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_10_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_10_PUB_18_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_10_PUB_18_circuit(
            ...
            } // log_n -1 = 9 points || Proof points 10-18
            for lib_comm in full_proof.proof.libra_commitments {
                _points.append((*lib_comm).into());
            } // 3 points || Proof points 19-21
            _points.append(full_proof.proof.kzg_quotient.into()); // Proof point 22
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_44, scalar_45, scalar_46, scalar_47, scalar_48, scalar_49,
                transcript.shplonk_z.into(), scalar_50,
            ]
                .span();

            // Check input points are on curve.
            // Skip the first 28 points as they are from VK and keep the last 22 proof points
            for point in points.slice(28, 22) {
                assert(
