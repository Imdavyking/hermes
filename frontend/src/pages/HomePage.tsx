        ...
        <section style={{
          ...
          <div style={{ animation: "hero-reveal 0.6s ease both" }}>
            ...
            <div style={{
              ...
              <span style={{ width: 5, height: 5, borderRadius: "50%", background: "var(--orange)", display: "block" }} />
              <span style={{ fontSize: "0.52rem", color: "var(--orange)", letterSpacing: "0.2em" }}>
            ...
            <p style={{
              ...
              Automated USDC → native Bitcoin purchases delivered directly
              to your Bitcoin wallet. No bridging. No wrapping. Real BTC.
            </p>
            ...
            <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
              ...
              <span style={{ fontSize: "0.58rem", color: "var(--muted2)", letterSpacing: "0.08em" }}>
                Starknet Sepolia
              </span>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontFamily: "var(--display)", fontSize: "0.7rem", color: "var(--orange)", letterSpacing: "0.15em" }}>
                  LIVE ORACLE
                </span>
                <span style={{
                  fontSize: "0.48rem", color: "var(--green)",
                  letterSpacing: "0.15em",
                  display: "flex", alignItems: "center", gap: "0.35rem",
                }}>
                  <span style={{ width: 5, height: 5, borderRadius: "50%", background: "var(--green)", display: "block", boxShadow: "0 0 4px var(--green)" }} />
                  CHAINLINK + PRAGMA
                </span>
              </div>
              ...
              <div style={{ padding: "2rem 1rem", textAlign: "center" }}>
                <div style={{ fontSize: "0.52rem", color: "var(--muted)", letterSpacing: "0.2em", marginBottom: "0.5rem" }}>
                  BTC / USD
                </div>
                <div style={{
                  fontFamily: "var(--display)",
                ...
                <div style={{
                  fontSize: "0.55rem", color: "var(--muted2)",
              ...
              <div style={{
                ...
                <span style={{ fontSize: "0.58rem", color: "var(--muted)", letterSpacing: "0.08em" }}>STRK / USD</span>
                <span style={{ fontSize: "0.72rem", color: "var(--text)", fontFamily: "var(--mono)" }}>
            ...
            <div style={{
              ...
              <span style={{ fontSize: "0.56rem", color: "var(--muted2)", letterSpacing: "0.08em" }}>
                KEEPER FEE PER INTERVAL
              </span>
              <span style={{ fontSize: "0.7rem", color: "var(--text2)" }}>0.5 STRK</span>
            </div>
          </div>
        </section>
            ...
            {FEATURES.map(({ label, sub }) => (
              <div key={label} style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: "0.7rem", color: "var(--text)", letterSpacing: "0.06em" }}>{label}</span>
                </div>
                <span style={{ fontSize: "0.55rem", color: "var(--muted)", letterSpacing: "0.06em", paddingLeft: "1rem" }}>
                  {sub}
                </span>
              </div>
            ))}
